...
export const initialPlantState: PlantState = {
  list: [
    ...
    {
      id: createPlantId(),
      name: "Abricotier commerce / Reine-Claude commerce" as PlantName,
      position: {
    ...
    {
      id: createPlantId(),
      name: "Sureau Annie" as PlantName,
      position: {
    ...
    {
      id: createPlantId(),
      name: "Sureau Annie/Sylvie" as PlantName,
      position: {
    ...
    {
      id: createPlantId(),
      name: "Sureau Sylvie" as PlantName,
      position: {
    ...
    {
      id: createPlantId(),
      name: "Abricotier Annie" as PlantName,
      position: {
    ...
    {
      id: createPlantId(),
      name: "Cerisier Erquy les Hopitaux" as PlantName,
      position: {
    ...
    {
      id: createPlantId(),
      name: "Reine-Claude du commerce" as PlantName,
      position: {
